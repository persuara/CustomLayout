...
class ViewController: UIViewController {
   ...
   lazy var array: [Model] = [
        .init(size: CGSize(width: 150 , height: 80)),
        .init(size: CGSize(width: 150, height: 40)),
        .init(size: CGSize(width: 150, height: 90)),
        .init(size: CGSize(width: 150, height: 150)),
        .init(size: CGSize(width: 150, height: 200)),
        .init(size: CGSize(width: 150, height: 130)),
        .init(size: CGSize(width: 150, height: 110)),
        .init(size: CGSize(width: 150, height: 120)),
        .init(size: CGSize(width: 150, height: 70)),
        .init(size: CGSize(width: 150, height: 90)),
        .init(size: CGSize(width: 150, height: 50)),
        .init(size: CGSize(width: 150, height: 150)),
        .init(size: CGSize(width: 150, height: 310)),
        .init(size: CGSize(width: 150, height: 150)),
