...
class ViewController: UIViewController {
   ...
   lazy var array: [Model] = [
        ...
        .init(size: CGSize(width: widthConstant / 1.75 - 7, height: 150)),
        .init(size: CGSize(width: widthConstant / 3 - 7, height: 290)),
        .init(size: CGSize(width: widthConstant / 4 - 7, height: 130)),
        .init(size: CGSize(width: widthConstant / 2.5 - 7, height: 110)),
        .init(size: CGSize(width: widthConstant / 5 - 7, height: 80)),
        .init(size: CGSize(width: widthConstant / 4.5 - 7, height: 50)),
        .init(size: CGSize(width: widthConstant / 4.5 - 7, height: 50)),
